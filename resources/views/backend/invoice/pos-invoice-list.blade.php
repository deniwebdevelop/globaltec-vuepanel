          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                 <h3 class="p-1 font-weight-light">Listado
                  <!-- <a class="btn btn-success float-right btn-sm"
                    href=""><i class="fa fa-plus-circle p-2"></i>Nueva Factura</a> -->
                 </h3>
                </div>
              </div><!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <a title="print" class="btn btn-sm btn-success" href="{{ route('invoice.print', $invoice->id) }}"
