          ...
          <section class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                 <h3 class="p-1 font-weight-light">Pago Recibido
                     <a class="btn btn-success float-right btn-sm" href="{{ route('customers.paid.pdf') }}" target="_blank"><i class="fa fa-download p-2"></i>Descargar PDF</a>
                 </h3>
                </div>
              </div><!-- /.card-header -->
              <div class="card-body">
